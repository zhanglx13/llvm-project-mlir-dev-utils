...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{tikzpicture}[overlay, remember picture]
      ...
      %% Exceptions
      \draw [red, thick] ($(tab TL)+(0.03, -1.75)$) rectangle ++(6.3, -.6);
      \draw [red, thick] ($(tab TL)+(0.03, -3.77)$) rectangle ++(6.3, -.66);
...
\begin{frame}
  ...
  \begin{tikzpicture}
    ...
    { r0 [-1, 1] vs. r4 [1, 5]};
    %% Exceptions
    %\draw [red, thick] ($(tab TL)+(0.03, -1.78)$) rectangle ++(6.3, -.6);
    %\draw [red, thick] ($(tab TL)+(0.03, -3.77)$) rectangle ++(6.3, -.66);
    %\draw [blue, thick] ($(tab TL)+(0.03, -1.4)$) rectangle ++(6.3, -.3);
  \end{tikzpicture}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{tikzpicture}[overlay, remember picture]
      ...
      \node [below right, align=left, scale=.9] at ($(tab TL)+(0,-5.1)$)
      { \texttt{acc 4}: truncate the sum of every 4 multiplications from fp64 to fp32\\
        \texttt{flush}: flush small numbers ($<2^{-14}$) to zero};
      %% Exceptions
    ...
    \item \texttt{flush}: \texttt{mfma} instructions on MI200\\
